...
const styles = StyleSheet.create({
  ...
  left: { flex: 1 },
  totalHours: { fontSize: 36, fontWeight: "700", color: COLORS.navy, letterSpacing: -0.8 },
  subLabel: { fontSize: 15, color: COLORS.muted, fontWeight: "600", marginTop: 4 },
  ...
  pctLine: { fontSize: 15, color: COLORS.muted, fontWeight: "600", marginTop: 8 },
  pctValue: { fontWeight: "700" },
  ...
  ringPct: { fontSize: 28, fontWeight: "700", color: COLORS.navy, letterSpacing: -0.5 },
  ringSub: { fontSize: 15, fontWeight: "600", color: COLORS.muted },
  ...
  chipValue: { fontSize: 17, fontWeight: "700", letterSpacing: -0.2, marginTop: 2, color: COLORS.navy },
  statusRow: { flexDirection: "row", alignItems: "center", gap: 10, marginTop: 16 },
  statusBadge: { paddingHorizontal: 12, paddingVertical: 5, borderRadius: 20 },
  statusBadgeText: { fontSize: 13, fontWeight: "700", color: COLORS.onAccent },
  paceText: { fontSize: 14, color: COLORS.muted, fontWeight: "600" },
});