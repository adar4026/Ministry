...
const styles = StyleSheet.create({
  ...
  date: { fontSize: 16, fontWeight: "600", color: COLORS.muted },
  status: { fontSize: 18, fontWeight: "700", color: COLORS.text, marginTop: 10 },
  hero: { marginTop: 20 },
  heroLabel: { fontSize: 16, color: COLORS.muted },
  heroValue: { fontSize: 36, fontWeight: "700", color: COLORS.blue, marginTop: 2 },
  secondaryRow: { flexDirection: "row", gap: 24, marginTop: 20 },
  secondaryItem: { flex: 1 },
  secondaryLabel: { fontSize: 14, color: COLORS.muted, minHeight: 32 },
  secondaryValue: { fontSize: 23, fontWeight: "700", color: COLORS.text, marginTop: 2 },
  footnote: { fontSize: 14, color: COLORS.muted, marginTop: 16 },
});
