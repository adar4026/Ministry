...
const styles = StyleSheet.create({
  ...
  name: { fontSize: 12.5, fontWeight: "700", color: MINISTRY.ink2, letterSpacing: 0.1, textAlign: "center" },
  date: { fontSize: 12, fontWeight: "500", color: MINISTRY.ink2, opacity: 0.8, textAlign: "center" },
});
