...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 12, fontWeight: "600", color: COLORS.muted },
  ...
  projValue: { fontSize: 28, fontWeight: "700", letterSpacing: -0.6 },
  projSub: { fontSize: 12, fontWeight: "600", marginTop: 4 },
  detail: { fontSize: 13, fontWeight: "600", color: COLORS.accent, marginTop: 8 },
  ...
  footerValue: { fontSize: 17, fontWeight: "700", color: COLORS.navy, marginTop: 2 },
});