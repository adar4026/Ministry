...
const styles = StyleSheet.create({
  ...
  value: { fontSize: 24, fontWeight: "700", color: COLORS.navy, letterSpacing: -0.4 },
  unit: { fontSize: 12, fontWeight: "600", color: COLORS.muted, marginTop: 2 },
  ...
  trendLabel: { fontSize: 13, fontWeight: "600", color: COLORS.muted },
  trendValue: { fontSize: 15, fontWeight: "700" },
