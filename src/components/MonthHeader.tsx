...
const styles = StyleSheet.create({
  ...
  titleWrap: { gap: 2 },
  monthLabel: { fontSize: 21, fontWeight: "700", color: COLORS.text, letterSpacing: -0.3 },
  syLabel: { fontSize: 13, fontWeight: "600", color: COLORS.muted },
  sourceBadge: {
  ...
  stat: { flex: 1 },
  statValue: { fontSize: 23, fontWeight: "700", color: COLORS.text, letterSpacing: -0.3 },
