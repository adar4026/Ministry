...
describe("profileMenu", () => {
  it("keeps the TASK_044/059 settings rows, in order, with Уведомления, Календарь служения (TASK_083), Статистика (TASK_081) and Оформление (TASK_078) routed", () => {
