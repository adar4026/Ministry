...
const styles = StyleSheet.create({
  ...
  empty: { fontSize: 14, color: COLORS.muted, textAlign: "center", marginTop: 24 },
  sy: { fontSize: 15, fontWeight: "700", color: COLORS.text, marginBottom: 8 },
  monthBlock: { marginBottom: 10 },
  monthLabel: { fontSize: 13, fontWeight: "700", color: COLORS.muted, marginBottom: 4 },
  sessionRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  ...
  sessionDuration: { fontSize: 13, color: COLORS.blue, fontWeight: "700" },
  ...
  legacyText: { fontSize: 12, color: COLORS.muted },
});
