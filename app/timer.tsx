...
const styles = StyleSheet.create({
  ...
  saveLabel: { fontSize: 12, fontWeight: "600", color: "#3b82f6" },
  saveDateValue: { fontSize: 16, fontWeight: "600", color: "#1e293b" },
  saveInput: { width: "100%", borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, color: "#1e293b", backgroundColor: "#fff" },
